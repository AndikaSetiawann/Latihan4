...
```
UPDATE dosen SET kd_ds = 'DS005' WHERE nama = 'Cortois';
```
Perintah di atas akan mengubah nilai kolom `"kd_ds" "Cortois" menjadi "DS005" pada tabel "dosen"`. Anda dapat menyesuaikan nilai yang ingin Anda ubah dan kondisi WHERE sesuai dengan kebutuhan Anda.
...
- [Link Laporan Praktikum](https://drive.google.com/drive/u/0/folders/1NSQpw8XcJjZSiEUF0dxCSLph5rw8v8F-)
